...
cp DCE_IDandPhaseSelect/Breast_DCEMRI_FTV_plugins1/Exam_Ident_and_timing.py ~/tmp/Slicer-5.6.0-linux-amd64/slicer.org/Extensions-32390/Breast_DCEMRI_FTV/lib/Slicer-5.6/qt-scripted-modules/Breast_DCEMRI_FTV_plugins1/Exam_Ident_and_timing.py
